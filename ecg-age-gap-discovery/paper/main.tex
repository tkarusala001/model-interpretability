...
cardiovascular ageing, and reported to predict mortality
\citep{lima2021ecgage}. Predicting age from an ECG is an established task
...
control) and external replication. Chapman-Shaoxing-Ningbo
\citep{zheng2020chapman} comprises 24{,}000 recordings from three Chinese
hospitals, sharing no data with PTB-XL. Every interval excludes zero.}
