...
$\Delta$AUC, myocardial infarction & \textbf{+0.015}$^{*}$ & +0.007 & \textbf{+0.001} \\
$\Delta$AUC, normal & +0.008$^{*}$ & +0.012$^{*}$ & +0.002$^{*}$ \\
\bottomrule
\end{tabular}
\vspace{2pt}
...
value to $+0.001$ AUC. We fixed a clinical-relevance threshold of 0.020 AUC
before examining any data; every remaining effect falls below it, and our
